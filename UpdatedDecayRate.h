#ifndef updateddecayrates_h
#define updateddecayrates_h
...
public :
	static void FFfunctionsCLN(double w, vector<parameter> FFpar, double& Gw, double& f0);
	static void FFfunctionsCLN(double w, vector<parameter> FFpar, double& hw, double& R1w, double& R2w, double& R0w);
	static void FFfunctionsBGL(double w, vector<parameter> FFpar, double& Gw, double& f0);
	static void FFfunctionsBGL(double w, vector<parameter> FFpar, double& A1, double& A2, double& V, double& A0);
